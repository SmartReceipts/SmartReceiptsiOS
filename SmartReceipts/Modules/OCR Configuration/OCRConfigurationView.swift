...
final class OCRConfigurationView: UserInterface {
    ...
    @IBOutlet weak var availablePurchases: UILabel!
    @IBOutlet private weak var closeButton: UIBarButtonItem!
    @IBOutlet weak var scans10button: ScansPurchaseButton!
    @IBOutlet weak var scans50button: ScansPurchaseButton!
    ...
    private func configureView() {
        if FeatureFlags.newSubscription.isEnabled {
            ...
            scans50button.isHidden = true
        } else {
            openSubscriptionButton.isHidden = true
            availablePurchases.isHidden = false
            scans10button.isHidden = false
            scans50button.isHidden = false
        }
    }
